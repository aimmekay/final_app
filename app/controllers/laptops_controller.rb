class LaptopsController < ApplicationController
  ...
  private
    ...
    def laptop_params
      params.require(:laptop).permit(:manufacturer, :model, :jslgTag, :manufacturerTag, :serialNumber, :osType, :hostName, :ram, :hdd, :department, :location, :assignedTo, :status, :notes)
    end
end
